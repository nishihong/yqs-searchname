...
jQuery.extend({
	...
	loading_color : {'bgColor':'#000000', 'fontColor':'#037C11', 'ldColor':'#037C11', 'hoverColor':'#F5F5F5'},
	
	_loading_init : function(){
		$("body").append("<div id='loading-background' style='display:none;z-index:99999998;left:0;top:0;'></div><div style='display:none;z-index:99999999;' id='loading-container'><div class='loading-div' style='width:100%;height:38px;text-align:center;color:"+this.loading_color.fontColor+";font-weight:bold;font-size:1.5em;'></div><p class='loading-p' style='width:220px;height:22px;margin:auto;'></p></div>");
